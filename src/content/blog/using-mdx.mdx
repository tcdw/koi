---
title: '使用 MDX'
description: '这个主题自带了 @astrojs/mdx 的集成，并在您的 astro.config.mjs 配置文件中进行了配置。如果您不想使用 MDX，您可以通过从配置文件中删除集成来禁用支持。'
pubDate: 'Jul 09 2022'
heroImage: '/blog-placeholder-5.jpg'
---

这个主题自带了 [@astrojs/mdx](https://docs.astro.build/en/guides/integrations-guide/mdx/) 的集成，并在您的 `astro.config.mjs` 配置文件中进行了配置。如果您不想使用 MDX，您可以通过从配置文件中删除集成来禁用支持。
